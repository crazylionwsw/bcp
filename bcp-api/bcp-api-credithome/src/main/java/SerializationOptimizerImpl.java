...
import com.fuze.bcp.api.credithome.bean.APIHomeBillBean;
...
import com.fuze.bcp.api.credithome.bean.HomeBillSubmissionBean;
...
public class SerializationOptimizerImpl implements SerializationOptimizer {
    ...
    public Collection<Class> getSerializableClasses() {
        ...
        classes.add(APIHomeBillBean.class);
        classes.add(DomesticOutfitBean.class);
        classes.add(DomesticOutfitSubmissionBean.class);
        classes.add(HomeBillSubmissionBean.class);
