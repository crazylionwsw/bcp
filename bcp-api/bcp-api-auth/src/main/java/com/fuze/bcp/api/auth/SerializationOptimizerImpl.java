...
public class SerializationOptimizerImpl implements SerializationOptimizer {
    ...
    public Collection<Class> getSerializableClasses() {
        ...
        classes.add(RegistBean.class);
        classes.add(RegistUserBean.class);
        classes.add(SysResourceBean.class);
        classes.add(SysRoleBean.class);
