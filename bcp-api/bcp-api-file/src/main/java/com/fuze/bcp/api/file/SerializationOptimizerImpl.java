...
public class SerializationOptimizerImpl implements SerializationOptimizer {
    ...
    public Collection<Class> getSerializableClasses() {
        ...
        classes.add(DocumentTypeBean.class);
        classes.add(EmailObjectBean.class);
        classes.add(FileBean.class);
        classes.add(PushObjectBean.class);
        classes.add(TemplateObjectBean.class);
