 ...
 */
package com.fuze.bcp.api.transaction;
...
public class SerializationOptimizerImpl implements SerializationOptimizer {
    ...
    public Collection<Class> getSerializableClasses() {
        ...
        classes.add(PadCustomerTransactionBean.class);
        classes.add(TransactionStageBean.class);
        classes.add(TransactionSummaryBean.class);
