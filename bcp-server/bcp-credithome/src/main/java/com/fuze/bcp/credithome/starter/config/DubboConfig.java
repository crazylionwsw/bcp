package com.fuze.bcp.credithome.starter.config;
...
public class DubboConfig {
    ...
    public ProtocolConfig creditcarDubbo() {
        ...
        protocolConfig.setPort(20896);
        protocolConfig.setSerialization("kryo");
//        protocolConfig.setOptimizer("com.fuze.bcp.api.credithome.SerializationOptimizerImpl");
