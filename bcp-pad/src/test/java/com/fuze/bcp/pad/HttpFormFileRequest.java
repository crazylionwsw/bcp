...
public class HttpFormFileRequest {
    //每个post参数之间的分隔
    ...
    public HttpFormFileRequest(String urlStr, List<String[]> strParams, List<String[]> fileParams) {
        this.urlStr = urlStr;
    ...
    public byte[] sendPost() throws Exception {
        ...
        try {
            ...
            hc.setRequestProperty("Client-Type","BTV-W09");
            hc.setRequestProperty("deviceType","Android HUAWEI BTV-W09");
            hc.setRequestProperty("userToken","eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxODIxMTA5OTgyNyIsImF1ZGllbmNlIjoiQW5kcm9pZCBIVUFXRUkgQlRWLVcwOSIsImNyZWF0ZWQiOjE1MTE4Mzc3MDk5OTd9.gPl8VnpdE3C8KhpGZEZcNl4HHNvCAtX6RKunU8sBIm_SQQMhMrszY9uZgIouGHgfdULol8Y9KF5Kjvi5xCDbRg");
            // 发送POST请求必须设置如下两行
            hc.setDoOutput(true);
            hc.setDoInput(true);
