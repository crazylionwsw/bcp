...
var TEMPLATE = '<div class="viewer-container">' + '<div class="viewer-canvas"></div>' + '<div class="viewer-footer">' + '<div class="viewer-title"></div>' + '<ul class="viewer-toolbar">' + '<li class="viewer-download" data-action="download" title="下载"></li>' + '<li class="viewer-zoom-in" data-action="zoom-in" title="放大"></li>' + '<li class="viewer-zoom-out" data-action="zoom-out" title="缩小"></li>' + '<li class="viewer-one-to-one" data-action="one-to-one" title="还原"></li>' + '<li class="viewer-reset" data-action="reset" title="刷新"></li>' + '<li class="viewer-prev" data-action="prev" title="上一张"></li>' + '<li class="viewer-play" data-action="play" title="轮播"></li>' + '<li class="viewer-next" data-action="next" title="下一张"></li>' + '<li class="viewer-rotate-left" data-action="rotate-left" title="左转"></li>' + '<li class="viewer-rotate-right" data-action="rotate-right" title="右转"></li>' + '<li class="viewer-flip-horizontal" data-action="flip-horizontal" title="左右翻转"></li>' + '<li class="viewer-flip-vertical" data-action="flip-vertical" title="上下翻转"></li>' + '<li class="viewer-print" data-action="print" title="打印"></li>' + '</ul>' + '<div class="viewer-navbar">' + '<ul class="viewer-list"></ul>' + '</div>' + '</div>' + '<div class="viewer-tooltip"></div>' + '<div class="viewer-button" data-action="mix"></div>' + '<div class="viewer-player"></div>' + '</div>';
...
//    if (!self.ready || !self.visible || self.played || index < 0 || index >= self.length || self.viewed && index === self.index) {
      if (!self.ready || !self.visible || self.played || index < 0 || self.viewed && index === self.index) {
        return self;
      }
  ...
  download: function download() {
    var self = this;
    window.win = open(self.image.currentSrc + "?forceDownload=1");
    //setTimeout('win.document.execCommand("SaveAs")', 500);
  },

  print: function print() {
    var self = this;
    window.win = open(self.image.currentSrc);
