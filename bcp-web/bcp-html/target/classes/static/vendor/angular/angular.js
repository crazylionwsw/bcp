 ...
 * <html>
 * <body>
 * <div ng-controller.js="WelcomeController">
 *   {{greeting}}
 * </div>
 *
 ...
 *   .controller.js('WelcomeController', function($scope) {
    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn,
      ...
      for (var i = 0, ii = directives.length; i < ii; i++) {
        ...
        if (!directive.templateUrl && directive.controller) {
          ...
          assertNoDuplicate("'" + directiveName + "' controller.js",
...
function $ControllerProvider() {
   ...
   * @description If called, allows `$controller.js` to find controller.js constructors on `window`
   */
  ...
  this.$get = ['$injector', '$window', function($injector, $window) {
    ...
    return function(expression, locals, later, ident) {
      // PRIVATE API:
      //   param `later` --- indicates that the controller.js's constructor is invoked at a later time.
      //                     If true, $controller.js will allocate the object with the correct
      //                     prototype chain, but will not invoke the controller.js until a returned
      //                     callback is invoked.
      //   param `ident` --- An optional label which overrides the label parsed from the controller.js
      //                     expression, if any.
      ...
      if (later) {
        // Instantiate controller.js later:
        // This machinery is used to create an instance of the object before calling the
        // controller.js's constructor itself.
        //
        // This allows properties to be added to the controller.js before the constructor is
    ...
    function addIdentifier(locals, identifier, instance, name) {
      if (!(locals && isObject(locals.$scope))) {
        throw minErr('$controller')('noscp',
          "Cannot export controller.js '{0}' as '{1}'! No $scope object provided via `locals`.",
          name, identifier);
      }
 ...
 *
 */
//asks for $scope to fool the BC controller.js module
