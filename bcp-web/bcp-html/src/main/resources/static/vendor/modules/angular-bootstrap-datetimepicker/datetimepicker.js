    ...
    function DirectiveController ($scope, $element, $attrs) {
      ...
      function hourModelFactory (milliseconds) {
        ...
        var result = {
          ...
          'previousViewDate': new DateObject({
            utcDateValue: previousViewDate.valueOf(),
            display: selectedDate.format('YYYY-MMM-DD HH')
          }),
      ...
      function minuteModelFactory (milliseconds) {
        ...
        var minuteFormat = 'YYYY-MMM-DD HH:mm'
        ...
        var result = {
          ...
          'previousViewDate': new DateObject({
            utcDateValue: previousViewDate.valueOf(),
            display: selectedDate.format('YYYY-MMM-DD HH:mm')
          }),
