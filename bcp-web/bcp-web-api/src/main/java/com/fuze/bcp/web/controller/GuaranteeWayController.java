...
public class GuaranteeWayController {
     ...
     * @return
     */
    @RequestMapping(value = "/guaranteeway/{id}", method = RequestMethod.GET)
    @ResponseBody
    public ResultBean getGuaranteeWay(@PathVariable("id") String id) {
        return iBaseDataBizService.actGetGuaranteeWay(id);
    }
