...
public class AuthController extends BaseController {
    ...
    public ResultBean<String> Oauth2API(HttpServletRequest request) {
        String resultUrl = iWechatBizService.getBelieveIp() + ":8080/#/wxlogin";
        String redirectUrl = "";
        if (resultUrl != null) {
            String requestUrl = request.getServerName() + ":" + request.getLocalPort();
            ...
            redirectUrl = iWechatBizService.oAuth2Url(backUrl).getD();
        }
...
/*    @RequestMapping(value = "/refresh", method = RequestMethod.GET)
    public ResultBean<String> refreshAndGetAuthenticationToken(HttpServletRequest request) {
        ...
        if (jwtTokenUtil.canTokenBeRefreshed(token, user.getLastPasswordResetTime())) {
            ...
            return ResultBean.getSucceed().setD(refreshedToken);
        } else {
